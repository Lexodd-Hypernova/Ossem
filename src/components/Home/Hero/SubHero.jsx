...
const textReveal =
  "We are evolved to make it easy for you to manage your organization by providing the right set of tools at the right place. Onboard and experience the transformation that you wished for. With us you can Learn, Grow and Succeed.";
      ...
      <div className="build__Sec">
        <div className="bld__Ttl">
          <h2>
            ...
            <br></br>
            <span className="ttl_stl2">Build to </span>
            <span className="ttl_stl3">Scale</span>
          </h2>
          <p>
        ...
        <div className="bld_ext-p">
          <p>Ossem: Bulit for Effective Management</p>
        </div>
      </div>
    </>
  );
